...
hero:
  image: '/static/images/blog/rebuilding-shariq-dev/hero.png'
  alt: 'The new shariq.dev homepage hero with the italic-serif title, portrait, and the featured post card.'
---
