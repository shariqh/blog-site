...
draft: false
summary: >-
  We take a look at how to install Docker and Docker Compose on Ubuntu, macOS,
  and Windows with WSL2.
canonical: >-
  https://www.bundleapps.io/blog/docker-series/pt-1-installing-docker-and-docker-compose
hero:
  image: >-
    /static/images/blog/docker-series/pt-1-installing-docker-and-docker-compose/cover.png
  alt: Cover illustration for "Installing Docker and Docker Compose".
  prompt: >-
    ...
    Concept: Installing Docker and Docker Compose. We take a look at how to
    install Docker and Docker Compose on Ubuntu, macOS, and Windows with WSL2.
