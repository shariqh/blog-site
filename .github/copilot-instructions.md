...
- The page UI is intentionally light-only; do not add `.dark` or `prefers-color-scheme` behavior to page styling unless the product direction changes. Browser/platform assets such as `public/favicon.svg` may provide explicit dark-chrome variants.
