...
<Image
  placeholder="blur"
  blurDataURL={'/static/images/be-shamelessly-cutting-edge/banner.png'}
  alt={'code of ethical behavior'}
  src={'/static/images/be-shamelessly-cutting-edge/banner.png'}
  width={1200}
  height={418}
/>
...
<Image
  placeholder="blur"
  blurDataURL={'/static/images/be-shamelessly-cutting-edge/choice.png'}
  alt={'code of ethical behavior'}
  src={'/static/images/be-shamelessly-cutting-edge/choice.png'}
  width={1200}
  height={440}
/>
...
<Image
  placeholder="blur"
  blurDataURL={'/static/images/be-shamelessly-cutting-edge/cutting-edge.png'}
  alt={'code of ethical behavior'}
  src={'/static/images/be-shamelessly-cutting-edge/cutting-edge.png'}
  width={1200}
  height={456}
/>
