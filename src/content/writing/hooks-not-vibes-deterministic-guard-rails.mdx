...
That loop, an independent model attacking my work the instant it exists, is an awesome payoff. The hook did not fix anything itself but it guaranteed the review happened on every PR no matter what state the context was in. I later measured how that review discipline held up across the whole repo, not just this one PR, in [a breakdown of every agent-labeled pull request Oris merged](/blog/ai-became-my-operating-model).
