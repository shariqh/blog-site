...
<Image
  src="/static/images/blog/the-night-i-shipped-lognote/out-of-memory.png"
  alt="macOS 'out of application memory' Force Quit dialog listing running apps by memory, with Obsidian at 64.01 GB"
  width={755}
  height={924}
/>
