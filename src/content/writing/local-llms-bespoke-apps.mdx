...
hero:
  ...
  prompt: >-
    ...
    Visual concept only: A compact lattice of small modular model blocks
    operating entirely inside a laptop-shaped boundary, feeding several bespoke
    application tools; a separate distant cloud shape is present but
    disconnected. Emphasize local containment, modularity, and purpose-built
    scale. No screens or UI panels.
