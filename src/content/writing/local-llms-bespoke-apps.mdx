...
tags:
  ...
  - ollama
  - privacy
summary: "Local LLMs give bespoke apps an on-device path, no per-token API bill, and control over model updates. Here's how we built that choice into Oris's summarization pipeline."
draft: false
---
