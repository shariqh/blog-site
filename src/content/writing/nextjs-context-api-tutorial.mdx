...
draft: false
summary: >-
  Using the latest features of the React Context API, we dive into leveraging
  these patterns for Next.js Context.
canonical: 'https://www.bundleapps.io/blog/nextjs-context-api-tutorial'
hero:
  image: /static/images/blog/nextjs-context-api-tutorial/cover.png
  alt: Cover illustration for "Next.js Context API Tutorial".
  prompt: >-
    ...
    Concept: Next.js Context API Tutorial. Using the latest features of the
    React Context API, we dive into leveraging these patterns for Next.js
    Context.
