...
draft: false
summary: >-
  CI CD is considered a tenet of software engineering, but continuous deployment
  is often ignored. Combined with the power of cloud native architecture, we
  examine tooling to achieve CI CD CD.
canonical: 'https://www.bundleapps.io/blog/cloud-native-flow'
hero:
  image: /static/images/blog/cloud-native-flow/cover.png
  alt: Cover illustration for "A Cloud Native CI/CD Flow".
  prompt: >-
    ...
    Concept: A Cloud Native CI/CD Flow. CI CD is considered a tenet of software
    engineering, but continuous deployment is often ignored. Combined with the
    power of cloud native architecture, we examine tooling to achieve CI CD CD.
