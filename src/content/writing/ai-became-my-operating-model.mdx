...
hero:
  ...
  prompt: >-
    ...
    Concept: AI Dev Workflow: What 86% Agent-Labeled PRs Actually Tell You. 86%
    of merged PRs were agent-labeled. Here's what those numbers actually reveal
    about running an AI-assisted software development workflow.
