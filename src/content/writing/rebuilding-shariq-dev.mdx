...
Both files were lifted near-wholesale from [`lognote`](https://github.com/shariqh/oris)'s editorial setup. The phrases are universal; the bucket mappings, length guidance, and frontmatter spec are this-blog-specific.
