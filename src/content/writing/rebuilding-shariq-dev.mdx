...
tags:
  ...
  - ai
summary: >-
  The old shariq.dev was a Tailwind/Next.js starter frozen since 2021. I rebuilt
  it as an AI-drafted, PR-reviewed publishing pipeline on Astro and Cloudflare
  Pages.
hero:
  image: /static/images/blog/rebuilding-shariq-dev/cover.png
  alt: Cover illustration for "Rebuilding shariq.dev".
  prompt: >-
    ...
    Concept: Rebuilding shariq.dev. The old shariq.dev was a Tailwind/Next.js
    starter frozen since 2021. I rebuilt it as an AI-drafted, PR-reviewed
    publishing pipeline on Astro and Cloudflare Pages.
